...
public class Evento {
    ...
    public Evento(int idEvento, int idUsuario, String nombre_evento, String descripcion, String hora_evento, String fecha_evento,
    ...
    public Evento(int idUsuario, String nombre_evento, String descripcion, String fecha_evento, String hora_evento, String lugar,
